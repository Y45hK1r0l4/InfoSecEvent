...
export async function POST(req: NextRequest){
    try {
        ...
        const mode = typeof event.mode === 'string' ? normalizeMode(event.mode) : event.mode;
        ...
        return NextResponse.json({ message: 'Event Creation Failed', error: 'Unknown error' }, { status: 500 });
    }
}
